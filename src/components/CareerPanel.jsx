...
export default function CareerPanel({ character, onCareerAction, onStudyDegree, onStudySchool }) {
  ...
  if (character.inPrison) {
    return (
      <>
        <EducationSection character={character} onStudyDegree={onStudyDegree} onStudySchool={onStudySchool} />
